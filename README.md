...
- من در اینجا سعی کردم یه مرحله مختلف برای استفاده از آرچ لینوکس رو تفکیک کنم که هر مرحله برای قشر خاصی مفید هست
  - در مرحله اول فقط یک سیستم عامل خالی نصب می‌کنم که بجز برنامهذهای لازم برای اتصال به اینترنت و همین طوری یک فایروال چیز اضافه‌ای روش نیست
  این روال ممکنه برای افراد ماهری و آشنا به آرچ کافی باشه تا دیگه بعدش بتونن سیستم رو بوت کنن و هرکاری که نیاز دارن انجام بدن، 
  ضمن اینکه برای یک سخت‌افزار خاص و کوچیک تا همین جاش کافیه که بشه به عنوان یک کامپیوتر ازش استفاده کرد. برنامه نویسی و وب‌گردی و...

  - مرحله بعدی بازم برای افراد آشنا به لینوکس هست اما برنامه‌هایی که بنظر برای بهینه سازی سیستم یا انجام برخی کارها لازم بودن رو اضافه کردم و همینطور
  ...
  - مرحله آخر هم برای افرادی هست که زیاد با لینوکس یا به طور خاص آرچ آشنا نیستن.
