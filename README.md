...
یک مورد خوب دیگه هم استفاده از اسنپ‌شات‌هایی بسیار کم حجم هست به طوری که اسنپ‌شات‌ها یجوری شبیه گیت فقط تغییرات رو ثبت می‌کنن و کلی ایمیج سنگین از کل پارتیشن‌های ما نمیسازن. btrfs این امکان رو میده تا تنظیم کنیم برای چه پارتیشن‌ها و حالا که بلدیم ساب‌ولیوم‌هایی اتوماتیک اسنپ‌شات تولید بشه یا اصلا تو اسنپ‌شات اونارو لحاظ نکنه و امکانات بیشتری که من هم نمیدونم  
 </details>
