...
# create another user
useradd -m -G wheel,realtime -s /bin/bash <your username>
...
تا اینجا شما یک آرچ مستقل رو روی سیستم مقصد نصب کردین
الان میتونید اون رو بوت کنید و دیگه از روی این سیستم جدید شروع کنید کاملش کنید
...
[این لینک](https://www.freecodecamp.org/news/vimrc-configuration-guide-customize-your-vim-editor/)
گفته شده استفاده کردم. البته روشهای خیلی زیادی وجود داره برای شروع یه نگاهی بهش بندازین
