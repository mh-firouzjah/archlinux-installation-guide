...
<details  dir="rtl">
  ...
  - دلیل اینکه سطح ۸ را انتخاب کردم این بود که هرچه داده فشرده‌تر باشد برای ssd بهتر هست، هرچند کمی برای سی‌پی‌یو کار اضافه دارد و زمان خواندن یا نوشتن آن هم بیشتر می‌شود ولی برای من این کیفیت بهتر به کمی صبوری می‌ارزد. ممکن است بیشتر راهنماها عدد ۱ را استفاده کنند، در هر صورت یک تست ساده برای مشاهدی زمان لازم برای فشرده کردن و خواندن دیتای فشرده شده به مانند عکس زیر خواهد بود
  
  ![Screenshot_20220822_195749](https://user-images.githubusercontent.com/44068054/185960031-e7857f13-b80f-432e-8686-d290b41fadba.png)
